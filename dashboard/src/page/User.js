...
function User() {
  ...
  useEffect(() => {
    const getUsers = async () => {
      const { data } = await axios.get(
        "http://217.182.207.129:8000/api/v1/users"
      );
      setUsers(data);
    };
    getUsers();
  ...
  const OnDelete = (id) => {
    if (window.confirm("are you sure to delete this user")) {
      axios
        .delete(`http://217.182.207.129:8000/api/v1/user/${id}`)
        .then((res) => {
            ...
            <table class="table">
              <thead>
                <tr>
                  ...
                  <th scope="col">prenom_utilisateur</th>
                  <th scope="col">email_utilisateur</th>
                  <th scope="col">password_utilisateur</th>
                  <th scope="col">pseudo</th>
                  <th scope="col">ville_utilisateur</th>
                </tr>
              </thead>
              <tbody>
                {users.map(
